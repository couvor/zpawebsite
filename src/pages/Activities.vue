...
const activities = [
  {
    date: '2026.03.21',
    title: '守护倡议快闪展',
    desc: '在城市公共空间展出“守护故事墙”，收集超过 600 条公众留言，形成线上数字档案。'
  },
  {
    date: '2026.03.08',
    title: '暖橙夜谈',
    desc: '邀请研究者、媒体人与社群成员进行开放式对谈，聚焦“理性表达与长期行动”。'
  },
  {
    date: '2026.02.15',
    title: '青年志愿训练营',
    desc: '开展三场工作坊，覆盖公共写作、视觉传播和项目协作，培养新一批核心志愿者。'
  },
  {
    date: '2026.01.12',
    title: '年度守护报告发布',
    desc: '发布年度工作报告，公开协作机制、活动成果与下一阶段目标，持续推进透明化。'
  }
]
</script>
